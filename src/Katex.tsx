    ...
    if (ref) {
      try {
        ...
        katex.render(src.replace(/\\\\/g, "\\"), ref, {
          ...
          strict: false,
          macros: {
            "\\iInf": "\\displaystyle \\inf",
            "\\iSup": "\\displaystyle \\sup",
            "\\McG": "\\mathcal{S}",
            "\\MfG": "\\mathfrak{S}",
            "\\McS": "\\htmlClass{text-McS-500}{\\mathcal{S}}",
            "\\MfS": "\\htmlClass{text-McS-500}{\\mathfrak{S}}",
            "\\McM": "\\mathcal{M}",
            "\\MfM": "\\mathfrak{M}",
            ...
            "\\wlp": "\\mathbf{\\H{wlp}}\\llbracket#1\\rrbracket(#2)",
            "\\wfp": "\\mathbf{\\H{wfp}}\\llbracket#1\\rrbracket(#2)",
