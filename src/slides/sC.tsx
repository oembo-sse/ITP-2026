...
export const sequenceB: State[] = [
  [...sequenceA, { ExpDef: "extended" } satisfies State].reduce((a, b) => ({
    ...a,
    ...b,
  })),
  ...
  makeSlide(sequence.length, () => {
    ...
    return (
      <appear.div className="flex justify-center flex-col items-center">
        <div className="text-2xl">title goes here</div>
        <appear.div
          show={!!state.ECDef}
        ...
        >
          ...
          >
            ...
            <appear.span>{tex`\McG : \text{Scheduler has this type}`}</appear.span>
          </appear.div>
        </appear.div>
        <appear.div
          show={!!state.ExpDef}
        ...
        >
          <appear.span className="text-3xl">
            {tex`\text{Pr}(s_1 \models \Diamond ${s2}) \quad=\quad \displaystyle \sum_{\pi \mem \Paths(s_1, ${s2})} \Prob(\pi)`}
          </appear.span>
          <appear.div
